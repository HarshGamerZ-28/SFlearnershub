    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="mb-6 sm:mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-500/10 border border-brand-500/20 text-brand-500 dark:text-brand-400 text-xs font-semibold uppercase tracking-wider mb-3">
            <BookOpen size={13} />
            Knowledge Base
          </div>
          <h1 className="font-display text-2xl xs:text-3xl sm:text-4xl font-extrabold mb-2 sm:mb-3">
